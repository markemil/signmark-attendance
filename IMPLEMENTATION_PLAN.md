...
| 6   | Implementation          | React/TS/Vite/Convex app                                                                 | ⬜ In progress — Epic 0, 1 (Auth), 3 (Clock In/Out), 4 (Calendar & Day Detail), 5 (Admin Proxy Punch), 6 (Holidays) done and verified                                                                                                                                              |
| 7   | Review & test           | —                                                                                        | ⬜                                                                                                                                                                                                                                                                                   |
