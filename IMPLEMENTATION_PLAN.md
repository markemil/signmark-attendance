...
| 9   | Version & deploy        | GitHub + Cloudflare Pages + Convex                                                       | ⬜ Live at [signmark-attendance.pages.dev](https://signmark-attendance.pages.dev) — points at Convex **dev** deployment for now; no GitHub repo yet |
